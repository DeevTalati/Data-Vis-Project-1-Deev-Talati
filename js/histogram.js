class Histogram {
    ...
    updateVis() {
        ...
        const xBuffer = Math.max(d3.max(validData) * 0.05, 1); // Adjust the buffer percentage as needed
        ...
        vis.svg.append('text')
            ...
            .attr('x', vis.width / 2)
            .attr('y', vis.height + vis.config.margin.top + 10) // Adjust the position as needed
            .style('text-anchor', 'middle')
            .text(vis.selectedVariable === 'urbanRuralStatus' ? 'Urban/Rural Status' : vis.selectedVariable); // Use the selected property as the x-axis title
        ...
        vis.svg.append('text')
            ...
            .attr('x', -vis.height / 2)
            .attr('y', -vis.config.margin.left + 30) // Adjust the position as needed
            .style('text-anchor', 'middle')
